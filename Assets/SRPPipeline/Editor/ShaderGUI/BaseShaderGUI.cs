    ...
    public abstract class BaseShaderGUI : ShaderGUI
    {
        ...
        protected class Styles
        {
            ...
            public static readonly GUIContent SurfaceOptions =
                new GUIContent("Surface Options", "Controls how RP renders the Material on a screen.");
            ...
            public static readonly GUIContent additionalOpaque = new GUIContent("Additional Opaque",
                "Set the material renderQueue to GeometryLast. This will render the object in addtional Opaque forward pass in Deferred Shading.");
        }
        ...
        protected MaterialProperty additionalOpaqueProp { get; set; }
        ...
        public virtual void FindProperties(MaterialProperty[] properties)
        {
            ...
            additionalOpaqueProp = FindProperty("_AdditionalOpaque", properties, false);
        }
        ...
        public virtual void DrawAdvancedOptions(Material material)
        {
            ...
            if(SurfaceType.Opaque == (SurfaceType)surfaceTypeProp.floatValue && additionalOpaqueProp != null)
            {
                EditorGUI.BeginChangeCheck();
                EditorGUI.showMixedValue = additionalOpaqueProp.hasMixedValue;
                var additionalOpaqueEnabled = EditorGUILayout.Toggle(Styles.additionalOpaque, additionalOpaqueProp.floatValue == 1);
                if (EditorGUI.EndChangeCheck())
                    additionalOpaqueProp.floatValue = additionalOpaqueEnabled ? 1 : 0;
                EditorGUI.showMixedValue = false;
            }
        }
        ...
        public static void SetupMaterialBlendMode(Material material)
        {
            if (material == null)
                throw new ArgumentNullException("material");
            bool emissiveEnable = (material.globalIlluminationFlags & MaterialGlobalIlluminationFlags.EmissiveIsBlack) == 0;
            ...
            if (material.HasProperty("_Surface"))
            {
                ...
                if (surfaceType == SurfaceType.Opaque)
                {
                    ...
                    var isAdditionalOpaque = material.HasProperty("_AdditionalOpaque") && material.GetFloat("_AdditionalOpaque") == 1.0f;
                    if (emissiveEnable || isAdditionalOpaque)
                    {
